...
(function($){
	jQuery.fn.canvasPicDialog = function(divId,dialogWidth,dialogHeigh,options) {
		var defaults = {
				scale:1,//是否允许缩放
				drawPencil:1,//画笔
				penWidth:1,//画笔粗细
				...
				frameColor:1,//线条颜色
				fillColor:1,//字体颜色
				frameDefaultColor: 'f50808',//边框默认颜色
		...
		canvasHtml +='</select>';
		canvasHtml +='</span>';
		canvasHtml +='<span style="display: block; float: left;margin-left: 10px;" id="fontSizeSpan">';
		...
		canvasHtml +='</select>'; 
		canvasHtml +='</span>';
		canvasHtml +='<span style="display: block; float: left;margin-left: 10px;" id="fontTypeSpan">';
		...
		canvasHtml +='</select>';
		canvasHtml +='</span>';
		canvasHtml +='<span style="display: block; float: left;margin-left: 10px;" id="frameColorSpan">';
		...
		canvasHtml +='</span>';
		canvasHtml +='<span style="display: block; float: left;margin-left: 10px;" id="fillColorSpan">';
		...
		*/
		...
		function initUI() {
			...
			$('#pic-dialog').dialog('option', 'zIndex', 1040);
