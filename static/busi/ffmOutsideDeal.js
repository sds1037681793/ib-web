...
FaultEventConfirmColor.put(3,"#2DBA6C");
FaultEventConfirmColor.put(7,"#EE0B0B");
...
function exportEventExecl() {
	...
	+ "&pageNumber=1&pageSize=1000&sortType=desc&sortName=id&systemType=3";
