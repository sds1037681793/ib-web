...
<body style="width: 1920px; height: 1080px;" >
	<div style="width: 1920px; height: 1080px; position: relative;" class="inner-div">
		<div id="groupMap" style="width: 1920px; height: 1080px; position: absolute; z-index: 0;"></div>
		<div class="head">
			...
			<div style="width: 1210px; height: 100%; float: left; padding-left: 30px;">
				<div style="float: left;">
					<div style="font-size: 30px; color: #FFFFFF; letter-spacing: 0; margin-top: 19px; width: 360px;">海智链物联网大数据平台</div>
					<div style="font-size: 14px; color: #FFFFFF; letter-spacing: 0.8px; width: 360px; padding-left: 2px;"></div>
				</div>
				<div style="float: left; margin-left: 576px; height: 100px; line-height: 100px; width: 80px;">
				...
				<div style="float: left; height: 100px; line-height: 100px; text-align: center; padding-top: 21px; padding-left: 20px">
					<span id="temperature" style="font-size: 24px; color: #FFFFFF; display: block; height: 33px; line-height: 33px;">--℃</span>
					...
					<table style="width: 100%; height: 100px;">
						<tr>
							<td style="padding-top: 16px; text-align: center; padding-left: 10px;">
								...
								<span id="master_total_unit" style="font-size: 14px; color: #FFFFFF; padding-top: 30px; padding-left: 4px; text-align: left; width: 30px;"></span>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="text-align: center; padding-top: 14px; padding-left: 15px;">
					...
					<table style="width: 100%; height: 100px;">
						<tr>
							<td style="padding-top: 16px; text-align: center; padding-left: 10px;">
								...
								<span id="master_abnormal_unit" style="font-size: 14px; color: #FFFFFF; padding-top: 30px; padding-left: 4px; text-align: left; width: 30px;">万</span>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="text-align: center; padding-top: 14px; padding-left: 15px;">
					...
					<table style="width: 100%; height: 100px; padding-left: 10px;">
						<tr>
							<td style="padding-top: 16px; text-align: center;">
								...
								<span id="master_fires_unit" style="font-size: 14px; color: #FFFFFF; padding-top: 30px; padding-left: 4px; text-align: left; width: 30px;"></span>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="text-align: center; padding-top: 14px; padding-left: 15px;">
					...
					<table style="width: 100%; height: 100px;">
						<tr>
							<td style="padding-top: 16px; text-align: center;">
								...
								<span id="ten_thousand" style="font-size: 14px; color: #FFFFFF; padding-top: 30px; padding-left: 4px; text-align: left; width: 30px;">万</span>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="text-align: center; padding-top: 14px; padding-left: 15px;">
		...
		<div
			style="width: 320px; height: 170px; margin: 0 auto; margin-top: 60px; position: relative; z-index: 99;">
			<div
				style="width: 100%; height: 50px; font-size: 36px; color: #FFFFFF; letter-spacing: 0; text-align: center;">项目分布总览</div>
			<div
				style="width: 100%; height: 28px; font-size: 20px; color: #FFFFFF; text-align: center; margin-top: 30px;">
				集团项目总数： <span id="organizeCount" style="font-size: 20px; color: #FFFFFF;">0</span>个
			</div>
			<div style="width: 100%; height: 40px; margin-top: 22px;">
			    <input id="codes" type="text" style="display:none;"/>
			    
				<input type="text" id="projectName" 
					onkeyup="getProjectData()" autocomplete="off" style="width: 234px; height: 40px; background-color: transparent; padding: 10px; border: 1px solid #00BFA5; font-size: 16px; color: rgba(255, 255, 255, 0.80);"
					placeholder="请输入项目名称">
					<div style="margin-left: 237px;margin-top: -40px;">
					<button id="search" 
					style="background: rgba(0, 191, 165, 0.6); width: 80px; height: 40px; border: 1px solid #00BFA5; font-size: 16px; color: rgba(255, 255, 255, 0.80); margin-left: -4px;">搜索</button>
					</div>
			   <span id="showNoProject" style="font-size: 16px; color: #F37B7B; letter-spacing: 0;face：PingFangSC-Regular"></span>
		...
		<div id="report_one_div" style="visibility: hidden;"
			...
			<div
				...
				<div style="font-size: 15px; color: #FFFFFF; letter-spacing: 0;">
					<span id="sjone"
						style="font-size: 15px; color: #FFFFFF; letter-spacing: 0;"></span>
				</div>
				<div
