...
<body style="line-height: 20px; height: 100%; margin: 0px; margin-top: -20px; background: #2E363F !important;">
	<div style="position: relative; height: 77px; width: 100%; z-index: -9; margin-top: 10px; outline: medium none !important;">
		<h2 style="padding-top: 20px; background-size: 10%; background-position: center left; height: 72px; margin-left: 10px;"></h2>
	</div>
	<div class="navbar user-nav" style="position: absolute; left: 28px; top: 0px; z-index: 20; margin: 0px; overflow: visible; outline: medium none">
		<ul class="nav">
			<li id="user-messages" class="dropdown">
				<a title="" href="#" data-toggle="dropdown" data-target="#user-messages" class="dropdown-toggle" style="background-color: #2E363F;">
					...
					<span id="operator-id" style="display: none">
						<shiro:principal property="id" />
					</span>
					<span id="login-name" style="display: none">
				...
				<ul class="dropdown-menu">
					<li>
						<a id="a-change-password" href="#">
							<span class="glyphicon glyphicon-pencil" style="color: #555; font-size: 13px; margin-right: 6px;"></span>
							修改密码
						</a>
					</li>
					...
					<li>
						<a href="${ctx}/logout">
							<span class="glyphicon glyphicon-log-out" style="color: #555; font-size: 13px; margin-right: 6px;"></span>
							注销
						</a>
					</li>
				</ul>
			</li>
			<li id="org-messages" class="dropdown" style="display: none;">
				<a id="a-login-org" title="" href="#" data-toggle="dropdown" data-target="#org-messages" class="dropdown-toggle" style="background-color: #2E363F;">
					<span id="login-organize-id" style="display: none">
						<shiro:principal property="organizeId" />
						^
						<shiro:principal property="organizeType" />
					</span>
					登录组织：
					<span id="login-organize-name">
						<shiro:principal property="organizeName" />
					</span>
					<b class="caret"></b>
				</a>
				<div id="select-operator-org"></div>
			</li>
			<li id="search-menu" class="dropdown" style="display: none;">
	...
	<div id="div-menu-object" style="display: none; float: left; position: relative; width: 220px; z-index: 16; outline: medium none"></div>
	<div id="content" style="background: #EEE none repeat scroll 0px 0px; margin-left: 0px; margin-right: 0px; padding-bottom: 25px; position: relative; min-height: 100%; width: auto; outline: medium none; min-height: 500px;">
