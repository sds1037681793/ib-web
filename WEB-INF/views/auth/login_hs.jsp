...
.login-background {
	margin: 0;
	padding: 0;
	background-image: url("${ctx}/static/img/login/hs/background.png");
	position: absolute;
	top: 0;
	left: 0;
	height: 100%;
	...
	<div id="main" style="height: 100%; width: 100%; position: absolute;">
		<div id="login">
			<form id="loginForm" action="${ctx}/login" method="post"
				style="margin-top: 26px; width: 100%;">
				<%
				...
				<div class="confirm">
					<div style="">
						<input id="submit-btn" class="btn btn-primary" type="button"
							value="登录" onclick="javascript:login();" /> <label
							class="checkbox" for="rememberMe"><input type="checkbox"
							id="rememberMe" name="rememberMe" checked="checked"
							style="display: none;" /> <img id="checkimg"
							src="${ctx}/static/img/login/newPage/jizhumimaxuanzhong.svg"
							onclick="checkclick()" /> <span
