...
<script type="text/javascript" src="${ctx}/static/busi/projectPageV5.js"></script>
<script type="text/javascript"
		...
		<div id="fire_fighting_skip" class="block"
			...
			<div
				...
				<div class="fires-item"
					...
					<p class="alerm-p1" id="fireNumber" style="color: #FF7171;">0</p>
					<p class="alerm-p2">实时火警总数</p>
				</div>
				<div class="fires-item"
					onclick="openFireFightingPage('FFM_OUTSIDE_PAGE')">
					<p class="alerm-p1" id="slbaNumber">0</p>
					<p class="alerm-p2">低电压报警总数</p>
				</div>
				<div class="fires-item"
					onclick="openFireFightingPage('FFM_OUTSIDE_PAGE')">
					<p class="alerm-p1" id="slfaNumber">0</p>
					<p class="alerm-p2">失联报警总数</p>
				</div>
				<div class="fires-item"
					onclick="openFireFightingPage('FFM_OUTSIDE_PAGE')">
					<p class="alerm-p1" id="soaNumber">0</p>
					<p class="alerm-p2">防拆报警总数</p>
				</div>
				<div class="fires-item"
					onclick="openFireFightingPage('FFM_OUTSIDE_PAGE')">
					<p class="alerm-p1" id="tpaNumber">0</p>
					<p class="alerm-p2">温度超限总数</p>
				</div>
			</div>
