 	...
 	<script type="text/javascript"> 
      ...
      //var dynamicreport;
 		$(document).ready(function(){
 			...
 			initPowerMonthNameList();
 		  	var infoCols = [
                ...
                {title : '合计',name : 'totalPrice',width : 80,sortable : false,align : 'left'}
             ]; 
 		...
 		tbEcTotal = $('#tb-ecTotal').mmGrid({
                ...
                height:776,
                cols:infoCols,
                url:'${ctx}/power-supply/supplyPowerMain/getPowerDailyReportData',
                method:'post',
                params:function(){
                	var data = {"": ""};
		...
		function exportExecl() {
        	...
        	var montTime = $("#powerMonthValue").val().trim();
        	var timestamp = yearTime+"-"+montTime;
			var url = "${ctx}/power-supply/supplyPowerMain/exportDailyExecl";
