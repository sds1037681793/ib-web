		...
		<form>
			<table style="min-width: 1000px;">
				<tr>
					...
					<td>
						<button id="export" name="export" type="button" class="btn btn-default btnicons" style="margin-left: 3rem;">
...
// 		}
		...
		function exportExecl() {
			...
			var prams = "?startTime=" + startTime + "&endTime=" + endTime+ "&level=" + level+ "&projectCode=" + projectCode
					+"&pageNumber=1&pageSize=500&sortType=desc&sortName=deviceNo&queryType=1";
