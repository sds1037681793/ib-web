...
<body class="elevator-alarm" style="margin-top: -5px;">
<label style="font-family: PingFangSC-Regular; font-size: 18px; color: #FFFFFF; letter-spacing: 0; margin-left: 270px;">电梯困人报警视频</label>
	<div style="padding-left: 52px;">
		<form id="alarm-video-form">
			<div style="position: relative; z-index: 9999; margin-top:10px">
...
<%--						<div id="alarm_Hint"  align="right" style="height: 17px;width: 57px;display: none;">
			...
			<div id="show_elevator_video"  class="right_box" style="height:340px;width:600px;display: none;">
				<iframe src="${ctx}/videomonitoring/showVideo?height=340&width=600"
					id="elevator-alarm-video" name="video-iframe" frameborder="0"></iframe>
			</div>
			<div  id="video_Off_Line" class="right_image" ><img alt="视频离线" src= "${ctx}/static/img/alarm/videoOffLine.png">  </div>
		</form>
	</div>
	<script  >
