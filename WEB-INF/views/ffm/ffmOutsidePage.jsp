...
<script src="${ctx}/static/busi/ffmOutsideRealTime.js"
	type="text/javascript"></script>
<script type="text/javascript" src="${ctx}/static/busi/ffmOutsideDeal.js"></script>
...
<body>
	<div class="content-select" style="min-width: 1620px; height: 900px;">
		...
		<div id="summary_total" style="width: 100%; height: 60px;">
			<div
				style="width: 80px; height: 30px; float: left; margin-top: 15px; margin-left: 20px; font-size: 16px; line-height: 30px;margin-bottom:15px;">
				实时概览：</div>
			<div id="huojing" class="summary_check" style="width: 111px;">
				<div class="div_style_one">
					<img id="huojing-img" src="${ctx}/static/img/ffm/baojing.svg">
				</div>
				<span class="div_style_six">火警</span>
				<div id="fires" class="div_style_two">0</div>
			</div>
			<div id="lowPowerAlarm" class="summary_check" style="width: 150px;">
				<div class="div_style_one">
					<img id="guzhang-img" src="${ctx}/static/img/ffm/hs/lowpower.svg">
				</div>
				<span class="div_style_six">低电压报警</span>
				<div id="slbaNumber" class="div_style_two">0</div>
			</div>
			<div id="lostConnectAlarm" class="summary_check"
				style="width: 165px;">
				<div class="div_style_one">
					<img id="huida-img" src="${ctx}/static/img/ffm/hs/lostConnect.svg">
				</div>
				<span class="div_style_six">烟感失联报警</span>
				<div id="slfaNumber" class="div_style_two">0</div>
			</div>
			<div id="fangchaiAlarm" class="summary_check" style="width: 165px;">
				<div class="div_style_one">
					<img id="huida-img" src="${ctx}/static/img/ffm/hs/fangchai.svg">
				</div>
				<span class="div_style_six">底座防拆报警</span>
				<div id="soaNumber" class="div_style_two">0</div>
			</div>
			<div id="tpaAlarm" class="summary_check" style="width: 165px;">
				<div class="div_style_one">
					<img id="huida-img" src="${ctx}/static/img/ffm/hs/tpa.svg">
				</div>
				<span class="div_style_six">温度超限报警</span>
				<div id="tpaNumber" class="div_style_two">0</div>
			</div>
			<div
				style="width: 260px; height: 60px; float: left; margin-left: 515px;display:none;">
				<div style="float: left; width: 140px;">
					<div class="div_style_four"
						style="color: #555; font-size: 14px; width: 70px;">王海峰</div>
					<div class="div_style_four"
						style="color: #999; font-size: 14px; width: 70px;">值班人员</div>
				</div>
				<div class="div_style_four"
					style="color: #555; font-size: 16px; width: 120px;">13567190082</div>
			</div>
			<div
		...
		<div id="history_total" style="width: 100%; height: 60px;">
			<div
				...
				历史概览：</div>
			<div id="weihuifu" class="history_check" style="width: 160px;">
				<div class="div_style_one">
					<img id="weihuifu-img" src="${ctx}/static/img/ffm/weihuifu.svg">
				</div>
				<div class="div_style_five">未恢复</div>
				<div class="div_style_two" id="no_revocery_num" style="width: 50px;"></div>
			</div>
			<div id="daiqueren" class="history_check" style="width: 160px;">
				<div class="div_style_one">
					<img id="daiqueren-img" src="${ctx}/static/img/ffm/daiqueren.svg">
				</div>
				<div class="div_style_five">未确定</div>
				<div class="div_style_two" id="no_confirm_num" style="width: 50px;"></div>
			</div>
<!-- 			<div -->
<!-- 				style="width: 260px; height: 60px; float: left; margin-left: 950px;"> -->
<!-- 				<div style="float: left; width: 140px;"> -->
<!-- 					<div class="div_style_four" -->
<!-- 						style="color: #555; font-size: 14px; width: 70px;">王海峰</div> -->
<!-- 					<div class="div_style_four" -->
